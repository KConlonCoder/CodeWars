...
function getCount(str) {
    ...
    //   Examine each letter in string against array of vowels. If included, increment the vowel counter by 1
      letters.forEach( letter => vowels.includes(letter) ? vowelsCount += 1 : vowelsCount );
